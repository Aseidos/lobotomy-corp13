...
/obj/item/ego_weapon/wield/supressed // Basically discount BLACK damage Flower Waltz mixed with Opression, hits like a truck, a VERY slow-moving truck.
...
/obj/item/ego_weapon/wield/supressed/attack(mob/living/target, mob/living/carbon/human/user)
	...
	if(user.sanity_lost)
		...
		stuntime = 30 // Even MORE stun if you are insane, because an insane with this weapon goes, hehe, insane
	..()
